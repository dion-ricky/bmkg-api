...
<body>
  <nav class="navbar navbar-expand-md navbar-light fixed-top bg-light shadow-sm">
    <img alt="logo" src="../branding_icon.ico" height="30.4" width="30.4">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
      <div class="navbar-nav">
        <a class="nav-item nav-link" href="../"><span class="fa fa-home"></span>&nbsp; Home <span class="sr-only">(current)</span></a>
        <a class="nav-item nav-link active" href="./"><span class="fa fa-lightbulb-o"></span>&nbsp; Examples</a>
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <main role="main" class="col" style="margin-top: 4rem">
        <div class="row">
          <div class="col mt-3">
            <div class="card">
          ...
          <div class="col mt-3">
            <div class="card">
              <div class="card-header">Siang</div>
              <div class="card-body">
          ...
          <div class="col mt-3">
            <div class="card">
              <div class="card-header">Dini Hari</div>
              <div class="card-body">
                <h5 class="card-title">Special title treatment</h5>
                <p class="card-text">With supporting text below as a natural lead-in to additional content.</p>
                <a href="#" class="btn btn-primary">Go somewhere</a>
